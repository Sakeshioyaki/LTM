      ...
      while(1){
        ...
        switch(mess.code){
          ...
          */
          ...
          user=loginUser(mess,newSocket,statususer,statuspass,sockfd);
            if(user != NULL){
          ...
          */
          case YC_KET_BAN :
            ...
            printf("ten nguoi dung muon ket ban la %s\n", mess.mess);
          ...
          case YC_XEM_BAN_BE:
            ...
            while(tmp1!=NULL){
              // counttmp++;
              // printf("counttmp co gia tri la %d\n",counttmp );
              strcpy(tmpName, tmp1->myFriend.name);
